...
import { weekdayNames, formatTimeslot } from "./dateUtils";

// Get desks for selected room
export const getDesksForRoom = (room: Resource, resources: Resource[]): Resource[] => {
...
export const getAvailableTimeslots = (desk: Resource, date: string): string[] => {
